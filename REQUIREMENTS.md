...
## 1. User Requirements
- UR-01: As a student, I want to check my clearance status so that I know if I am eligivble for enrollment.
- UR-02: As a librarian, I want to flag a student record so taht pending book fees halt their enrollment.
...
- NFR01: The clearance query must resolve and return a status in under 2.0 seconds.